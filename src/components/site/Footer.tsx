    ...
    <footer className="bg-[var(--brand-cocoa-deep)] text-[var(--brand-cream)]">
      <div className="mx-auto max-w-7xl px-4 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 text-xs">
          <span className="text-[var(--brand-cream)]/60">Follow us —</span>
          ...
          <a href="#" aria-label="Facebook" className="h-8 w-8 inline-flex items-center justify-center rounded-md bg-[var(--brand-cream)] text-[var(--brand-cocoa-deep)]"><Facebook className="h-4 w-4" /></a>
          <a href="#" aria-label="Twitter" className="h-8 w-8 inline-flex items-center justify-center rounded-md bg-[var(--brand-cream)] text-[var(--brand-cocoa-deep)]"><Twitter className="h-4 w-4" /></a>
        </div>
      </div>
    </footer>
  );
